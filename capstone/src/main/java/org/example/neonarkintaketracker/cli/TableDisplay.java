...
public class TableDisplay {
    ...
    public void displayOneCreature(JsonNode JSON){
        ...
        borderLine(125); // close table border
    }
    ...
    public void displayObservations(JsonNode JSON) {
        ...
        borderLine(120); // close header border
        ...
        borderLine(120); // close table border
    }
    ...
    public void displayFeedings(JsonNode JSON) {
        ...
        borderLine(140); // close the table border.
    }
